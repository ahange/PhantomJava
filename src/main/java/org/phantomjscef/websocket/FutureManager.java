...
public class FutureManager {
	private static final Map<String, CompletableFuture<Result>> map = new ConcurrentHashMap<>();
	...
	static CompletableFuture<Result> getCompletableFuture(String key){
		CompletableFuture<Result> cf = map.remove(key);
		return cf;
	}
	
	static CompletableFuture<Result> addCompletableFuture(Events ev, String uid){
	...
	public static CompletableFuture<Result> addAndWaitForCompletableFuture(Events ev, Page page) {
